...
assert(migratedM3.find((p) => p.marketId === "m3-3")?.team === "墨西哥/英格兰/民主刚果");
...
assert(migratedM3MexicoEngland.every((p) => p.team === "墨西哥/英格兰/民主刚果"), "m3 should drop 厄瓜多尔 from bracket option");
