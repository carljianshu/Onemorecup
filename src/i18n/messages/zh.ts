export const zh = {
  ...
  scoringRules: {
    ...
    title: "本金计算规则",
    suffix: "。",
    formula: "第二遍本金 = 10 ÷ 调整值",
    formulaAdjustment: "调整值 = σ ÷ 10",
    formulaNote: "调整值越小，本金越高，单题猜对/猜错的得分幅度也越大。",
    formulaSigmaNote: "σ 来自第一遍探测用得分序列的标准差，调整值衡量的是得分波动大小。",
    examplesTitle: "例子",
    formulaEx1: "10 人，5 对 5 错：调整值 = 1，本金 = 10。猜对者各 +10，猜错者各 −10。",
    formulaEx2: "10 人，1 对 9 错：调整值 = 3，本金 ≈ 3.33。猜对者 +30，猜错者各 −3.33。",
    formulaEx3:
      "10 人，2 对 8 错：调整值 = 2，本金 = 5。猜对者各 +20，猜错者各 −5。",
    formulaEx4:
      "10 人，9 对 1 错：调整值 = 3，本金 ≈ 3.33。猜对者各约 +0.37，猜错者 −3.33。",
    formulaEx5:
      "3 人，2 对 1 错：调整值约 1.41，本金约 7.07。猜对者各约 +3.54，猜错者 −7.07。"
  },
  markets: {
    page1: "第一页（{count} 题）",
