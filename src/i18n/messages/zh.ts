export const zh = {
    ...
    home: {
        ...
        rule2: "1/16决赛需至少竞猜 {page1Min} 场（{page1MapleMin}场枫叶，{page1CactusMin}场仙人掌），1/8决赛需至少竞猜 {page2Min} 场，两阶段合计需至少竞猜 {totalMin} 场。每阶段可选一场比赛 Double 双倍下注。",
    ...
    play: {
        ...
        page3DistributionNote: "红杉题调整系数：在本题已作答玩家中，统计各选项人数；人数最少的选项为 N 人，其余合计 M 人。参考盈亏序列为 M 个 −20、N 个 +20×M/N，标准差 σ÷20 = 调整系数，每位玩家实际本金 = 20÷调整系数。",
