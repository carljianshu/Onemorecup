export const zh = {
  ...
  play: {
    ...
    page3DistributionNote:
      "红杉题调整系数：在本题已作答玩家中，统计各选项人数；人数最少的选项为 N 人，其余合计 M 人。参考盈亏序列为 M 个 −20、N 个 +20×M/N，标准差 σ÷20 = 调整系数，每位玩家实际本金 = 20÷调整系数。",
    ...
    phase12MinNote:
      "1/16决赛至少猜8题，其中4题仙人掌4题枫叶；1/8决赛至少猜4题。1/16决赛和1/8决赛加起来至少猜16题。",
    ...
    doublePerMain: "，按大题",
    pleaseChoose: "请选择：",
    p1_1MexicoEcuadorNote: "如果苏格兰出线，墨西哥对阵苏格兰；否则墨西哥对阵厄瓜多尔",
    p1_2SwitzerlandIranNote: "如果伊朗出线，瑞士对阵伊朗",
    p1_5G1KoreaNote: "如果韩国出线，比利时对阵韩国",
    p1_7K1L3Note: "如果L3能出线的话，K1会对阵L3",
    p1_8L1K3Note: "如果K3能出线的话，L1会对阵K3",
    m1_9SouthAfricaCanadaLockNote: "本题6月28日19:00(UTC)后截止竞猜，已提交的答案会保留",
    m1_9SouthAfricaCanadaLockedNote: "本题已截止，无法再修改",
  ...
  admin: {
    ...
    publicAnswersDesc:
      "排行榜始终公开。答题总览默认隐藏；管理员可随时开关。到达预设时间后若仍为关闭，将自动向玩家开放（每轮时间仅自动一次）；玩家实际可见还需开关为打开且已到展示时间。",
