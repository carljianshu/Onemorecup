export const zh = {
  ...
  scoringRules: {
    ...
    s2Title: "2. 本金计算方法",
    s2Body:
      "设猜对、猜错玩家数量为 M 和 N。生成一个序列：序列里有 max(M,N) 个 −10，min(M,N) 个 10 × max(M,N) ÷ min(M,N)；计算这个序列的标准差 ÷ 10，得到调整值；用 $10 ÷ 调整值 得到本金。",
    s2Example:
      "例子：M = 2，N = 3，序列为 3 个 −10 与 2 个 +15，标准差 ≈ 12.25，调整值 ≈ 1.22，本金 = 10 ÷ 1.22 ≈ $8.17。按此本金结算时，猜错者各损失 $8.17，猜对者各获得 8.17 × 3 ÷ 2 ≈ $12.25。"
  },
  markets: {
    page1: "第一页（{count} 题）",
