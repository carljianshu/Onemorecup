export const zh = {
  ...
  scoringRules: {
    ...
    s2Title: "2. 本金调整",
    s2Body:
      "为平衡热门与冷门赛果，每题的投注本金会根据支持人数自动调整。\n\n设猜对人数为 M，猜错人数为 N。系统先根据两边人数生成一个参考盈亏序列：人数较多的一方记为 −10，人数较少的一方记为 +10×(较多人数÷较少人数)。计算该序列的标准差，并将其除以 10 得到调整系数。\n\n最终每位玩家的实际投注本金为：\n\n本金 = 10 ÷ 调整系数\n\n结算时，猜错玩家损失本金，猜对玩家平分猜错玩家的总投注。",
    s2Example:
      "例如：2 人猜对、3 人猜错时，参考序列为 −10、−10、−10、+15、+15。其标准差约为 12.25，对应调整系数约为 1.22，因此实际本金约为 $8.17。最终猜错者各损失 $8.17，猜对者各获得 $12.25。"
  },
  markets: {
    page1: "第一页（{count} 题）",
