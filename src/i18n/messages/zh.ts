export const zh = {
  ...
  scoringRules: {
    ...
    title: "投注积分计算",
    suffix: "。",
    summary: "猜对分猜错的钱，但先根据对错人数定一个调整系数，再按调整后的本金正式结算。",
    formulaTitle: "本金计算规则",
    ...
    formulaEx2: "1 对 9 错：调整值 = 3，本金 ≈ 3.33。猜对者 +30，猜错者各 −3.33。",
    s1Title: "基本规则",
    s1Item1: "每道题里，所有下注的玩家互相对赌。",
    s1Item2: "猜错扣分；猜对平分所有猜错者扣掉的分。",
    s1Item3: "普通下注 10 分；Double 算 2 个下注位，得失约 2 倍。",
    s2Title: "单题怎么算（两遍）",
    s2Item1: "第一遍（探测）：先用 10 分本金算一遍，只为了定「波动有多大」。",
    s2Item2:
      "定调整值：若猜对的人多于猜错的人，先把对错人数对调再算一串分数；否则用第一遍的真实分数。调整值 = 这串分数的标准差 ÷ 10。",
    s2Item3: "第二遍（正式得分）：新本金 = 10 ÷ 调整值；用新本金按真实对错再算一遍，这一遍才是该题得分。",
    s3Title: "特殊情况",
    s3Item1: "全员猜对或全员猜错 → 该题所有人 0 分。",
    s3Item2: "第二页锁定后，每少答 1 题再扣 10 分（与对赌分开扣）。",
    s4Title: "总分",
    s4Item1: "各题得分相加 − 缺答扣分 = 排行榜总分。"
  },
  markets: {
    page1: "第一页（{count} 题）",
