...
export const en: Messages = {
    ...
    home: {
        ...
        rule2: "Pick at least {page1Min} Round of 32 matches ({page1MapleMin} Maple, {page1CactusMin} Cactus) and at least {page2Min} Round of 16 matches ({totalMin} combined across both phases). You may Double one pick per phase.",
    ...
    play: {
        ...
        page3DistributionNote: "Sequoia adjustment: among picks on each question, let N = players on the least-chosen option and M = everyone else. Reference P/L = M entries at −20 and N at +20×M/N; adjustment = σ÷20 (std dev σ); stake per slot = 20÷adjustment.",
