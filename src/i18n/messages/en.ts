...
export const en: Messages = {
  ...
  play: {
    ...
    page3DistributionNote:
      "Sequoia adjustment: among picks on each question, let N = players on the least-chosen option and M = everyone else. Reference P/L = M entries at −20 and N at +20×M/N; adjustment = σ÷20 (std dev σ); stake per slot = 20÷adjustment.",
    ...
    pleaseChoose: "Choose:",
    p1_1MexicoEcuadorNote: "If Scotland advances, Mexico will face Scotland; otherwise Mexico will face Ecuador",
    p1_2SwitzerlandIranNote: "If Iran advances, Switzerland will face Iran",
    p1_5G1KoreaNote: "If South Korea advances, Belgium will face South Korea",
    p1_7K1L3Note: "K1 will face L3, if L3 advances",
    p1_8L1K3Note: "L1 will face K3, if K3 advances",
    m1_9SouthAfricaCanadaLockNote:
      "This match closes for picks after Jun 28, 19:00 UTC; saved picks are kept",
    m1_9SouthAfricaCanadaLockedNote: "This match is closed; picks cannot be changed",
  ...
  admin: {
    ...
    confirmGeneratePenaltiesPage3:
      "Apply quarter-finals+ deductions for promoted players ($20 × missing picks)?",
    ...
    publicAnswersDesc:
      "Leaderboard is always public. All picks are hidden by default; you can open or close each stage anytime. If still closed at the scheduled time, it opens automatically once per schedule; players only see picks when the switch is on and show time has passed.",
