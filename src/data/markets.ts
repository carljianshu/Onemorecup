...
export function renameM3BracketCandidatesInTeamName(team: string): string {
    return team
        .replaceAll("德国/巴拉圭/法国/瑞典", "法国")
        .replaceAll("巴拉圭/法国/瑞典", "法国")
        .replaceAll("巴拉圭/法国", "法国")
        .replaceAll("荷兰/摩洛哥/南非/加拿大", "摩洛哥")
        .replaceAll("荷兰/摩洛哥/加拿大", "摩洛哥")
        .replaceAll("摩洛哥/加拿大", "摩洛哥")
        .replaceAll("巴西/日本/科特迪瓦/挪威", "挪威")
        .replaceAll("巴西/科特迪瓦/挪威", "挪威")
        .replaceAll("巴西/挪威", "挪威")
        .replaceAll("西班牙/奥地利/葡萄牙/克罗地亚", "西班牙")
        .replaceAll("西班牙/葡萄牙", "西班牙")
        .replaceAll("西班牙区", "西班牙")
        .replaceAll("H1区", "西班牙")
        .replaceAll("美国/波黑/比利时/塞内加尔", "比利时")
        .replaceAll("美国/波黑/比利时", "比利时")
        .replaceAll("美国/比利时区", "比利时")
        .replaceAll("美国/比利时", "比利时")
        .replaceAll("美国/波黑", "美国")
        .replaceAll("墨西哥/厄瓜多尔/英格兰/民主刚果", "英格兰")
        .replaceAll("墨西哥/英格兰/民主刚果", "英格兰")
        .replaceAll("墨西哥/英格兰区", "英格兰")
        .replaceAll("墨西哥/L1区", "英格兰")
        .replaceAll("墨西哥/英格兰", "英格兰")
        .replaceAll("阿根廷/佛得角/澳大利亚/埃及", "阿根廷")
        .replaceAll("阿根廷/佛得角/埃及", "阿根廷")
        .replaceAll("阿根廷/埃及", "阿根廷")
        .replaceAll("阿根廷区", "阿根廷")
        .replaceAll("瑞士/阿尔及利亚/哥伦比亚/加纳", "瑞士")
        .replaceAll("瑞士/哥伦比亚/加纳", "瑞士")
        .replaceAll("瑞士/哥伦比亚", "瑞士")
        .replaceAll("瑞士/K1区", "瑞士")
        .replaceAll("瑞士/哥伦比亚区", "瑞士");
}
