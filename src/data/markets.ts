...
const LEGACY_CANDIDATE_ALIASES: Record<string, Record<string, string>> = {
    ...
    "m3-3": { "巴西区": "巴西/日本/科特迪瓦/挪威" },
    "m3-4": { "阿根廷区": "阿根廷/佛得角/澳大利亚/埃及", "瑞士/K1区": "瑞士/哥伦比亚区" },
    "m3-5": {
        "待填 1": "德国/巴拉圭/法国/瑞典",
        "德国/(法国/挪威)区": "德国/巴拉圭/法国/瑞典",
        "德国/I1区": "德国/巴拉圭/法国/瑞典",
...
export const DEFAULT_MARKETS: Market[] = [
    ...
    },
    {
        ...
        round: "M3",
        name: "第一场1/4决赛谁会晋级？",
        candidates: ["德国/巴拉圭/法国/瑞典", "荷兰/摩洛哥/南非/加拿大"],
        winner: null,
        page: 3
    },
    {
    ...
    },
    {
        ...
        round: "M3",
        name: "第三场1/4决赛谁会晋级？",
        candidates: ["巴西/日本/科特迪瓦/挪威", "墨西哥/英格兰区"],
        winner: null,
        page: 3
    },
    {
        ...
        round: "M3",
        name: "第四场1/4决赛谁会晋级？",
        candidates: ["阿根廷/佛得角/澳大利亚/埃及", "瑞士/哥伦比亚区"],
        winner: null,
        page: 3
    },
    {
