...
const LEGACY_CANDIDATE_ALIASES: Record<string, Record<string, string>> = {
    ...
    "m2-3": {
        "H1/(奥地利/阿尔及利亚)": "西班牙/奥地利",
        "西班牙/(奥地利/阿尔及利亚)": "西班牙/奥地利",
        "K2/L2": "葡萄牙/克罗地亚",
        "K2/克罗地亚": "葡萄牙/克罗地亚"
    },
    "m2-4": {
    ...
    "m2-6": {
        ...
        "L1/EIJK3": "英格兰/民主刚果",
        "L1/IJK3": "英格兰/民主刚果",
        "英格兰/(塞内加尔/J3/K3)": "英格兰/民主刚果",
        "英格兰/(塞内加尔/加纳)": "英格兰/民主刚果",
        "英格兰/(塞内加尔/K3)": "英格兰/民主刚果",
        "英格兰/(塞内加尔/民主刚果)": "英格兰/民主刚果",
        "英格兰/民主刚果": "英格兰/民主刚果"
    },
    "m2-2": {
        "南非/加拿大": "加拿大",
    ...
    "m3-1": {
        "德国/(法国/挪威)区": "德国/巴拉圭/法国/瑞典",
        "德国/I1区": "德国/巴拉圭/法国/瑞典",
        "德国/法国区": "德国/巴拉圭/法国/瑞典",
        "荷兰/摩洛哥/南非/加拿大": "荷兰/摩洛哥/加拿大",
        "荷兰区": "荷兰/摩洛哥/加拿大"
    },
    "m3-2": {
        "西班牙区": "西班牙/奥地利/葡萄牙/克罗地亚",
        "H1区": "西班牙/奥地利/葡萄牙/克罗地亚",
...
export function renameSwitzerlandRound1OpponentInTeamName(team: string): string {
    return team
        ...
        .replaceAll("瑞士/EFGIJ3", "瑞士/阿尔及利亚")
        .replaceAll("瑞士/EGIJ3", "瑞士/阿尔及利亚")
        .replaceAll("瑞士/(伊朗/J3)", "瑞士/阿尔及利亚")
...
export function renameM3BracketCandidatesInTeamName(team: string): string {
    return team
        .replaceAll("荷兰/摩洛哥/南非/加拿大", "荷兰/摩洛哥/加拿大")
...
/** 西班牙 1/16 对手 → 奥地利；1/8 联动选项同步。 */

export function renameSpainRound1OpponentInTeamName(team: string): string {
    return team
        .replaceAll("H1/(奥地利/阿尔及利亚)", "西班牙/奥地利")
        .replaceAll("西班牙/(奥地利/阿尔及利亚)", "西班牙/奥地利")
...
export function renameL1Round1OpponentInTeamName(team: string): string {
    return team
        ...
        .replaceAll("L1/EHIJK3", "英格兰/民主刚果")
        .replaceAll("L1/EIJK3", "英格兰/民主刚果")
        .replaceAll("L1/IJK3", "英格兰/民主刚果")
        .replaceAll("英格兰/EHIJK3", "英格兰/民主刚果")
        .replaceAll("英格兰/EIJK3", "英格兰/民主刚果")
        .replaceAll("英格兰/IJK3", "英格兰/民主刚果")
        .replaceAll("英格兰/(塞内加尔/J3/K3)", "英格兰/民主刚果")
        .replaceAll("英格兰/(塞内加尔/加纳)", "英格兰/民主刚果")
        .replaceAll("英格兰/(塞内加尔/K3)", "英格兰/民主刚果")
        .replaceAll("英格兰/(塞内加尔/民主刚果)", "英格兰/民主刚果")
...
export function renameG1Round1OpponentInTeamName(team: string): string {
    return team
        ...
        .replaceAll("G1/AEHIJ3", "比利时/塞内加尔")
        .replaceAll("G1/AHIJ3", "比利时/塞内加尔")
        .replaceAll("G1/AIJ3", "比利时/塞内加尔")
        .replaceAll("比利时/AIJ3", "比利时/塞内加尔")
        .replaceAll("比利时/(韩国/I3/J3)", "比利时/塞内加尔")
        .replaceAll("比利时/(韩国/塞内加尔/J3)", "比利时/塞内加尔")
...
export const DEFAULT_MARKETS: Market[] = [
    ...
    },
    {
        ...
        round: "M3",
        name: "第一场1/4决赛谁会晋级？",
        candidates: ["德国/巴拉圭/法国/瑞典", "荷兰/摩洛哥/加拿大"],
        winner: null,
        page: 3
    },
    {
        ...
        round: "M3",
        name: "第二场1/4决赛谁会晋级？",
        candidates: ["西班牙/奥地利/葡萄牙/克罗地亚", "美国/波黑/比利时/塞内加尔"],
        winner: null,
        page: 3
    },
    {
        ...
        round: "M3",
        name: "第三场1/4决赛谁会晋级？",
        candidates: ["巴西/日本/科特迪瓦/挪威", "墨西哥/厄瓜多尔/英格兰/民主刚果"],
        winner: null,
        page: 3
    },
    {
        ...
        round: "M3",
        name: "第四场1/4决赛谁会晋级？",
        candidates: ["阿根廷/佛得角/澳大利亚/埃及", "瑞士/阿尔及利亚/哥伦比亚/加纳"],
        winner: null,
        page: 3
    },
    {
